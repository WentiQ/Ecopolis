...
const OUTER_SPACES = [
  ...
  {id:33, type:'s-asset',  label:'Freshwater Aquifer Discovered', icon:'💧', points:5, modifiers:{wellbeing:4, capital:3, globalEco:3, land:2, vp:2}},
  {id:34, type:'s-event',  label:'Park',                 icon:'🌳', points:2, modifiers:{wellbeing:2, globalEco:1, capital:1}},
  {id:35, type:'s-event',  label:'Odd Even Rule',        icon:'🚗', points:2, modifiers:{pollution:-3, wellbeing:1}},
  {id:36, type:'s-event',  label:'Community Garden',     icon:'🌱', points:2, modifiers:{wellbeing:2, globalEco:2, capital:1, vp:1}},

  // BOTTOM EDGE CORNER
  {id:37, type:'s-corner', label:'RENEWABLE ENERGY',     icon:'⚡', points:4, modifiers:{capital:4, pollution:-5, globalEco:3, vp:2}},
  
  // BOTTOM EDGE (17 cards: right→left)
  {id:38, type:'s-event',  label:'Wildlife Protection',  icon:'🦌', points:3, modifiers:{globalEco:3, wellbeing:1, vp:1}},
  {id:39, type:'s-event',  label:'Industrialization',    icon:'🏭', points:1, modifiers:{capital:4, pollution:5}},
  {id:40, type:'s-event',  label:'Nuclear Waste Leak',   icon:'☢️', points:-10, modifiers:{pollution:10, globalEco:-6, wellbeing:-5, capital:-2}},
  {id:41, type:'s-event',  label:'Trust Issues',         icon:'🤝', points:-2, modifiers:{wellbeing:-2, capital:-1}},
  {id:42, type:'s-event',  label:'Reforestation Success',icon:'🌲', points:3, modifiers:{globalEco:4, pollution:-2}},
  {id:43, type:'s-event',  label:'River Fish Collapse',  icon:'🐟', points:-4, modifiers:{globalEco:-5, wellbeing:-2}},
  {id:44, type:'s-event',  label:'Zero Emission Fleet',  icon:'🚙', points:3, modifiers:{pollution:-4, capital:2}},
  {id:45, type:'s-event',  label:'Tsunami Hits',         icon:'🌊', points:-7, modifiers:{capital:-7, wellbeing:-5, globalEco:-3, land:-2}},
  {id:46, type:'s-event',  label:'Nuclear Attacks',      icon:'💣', points:-10, modifiers:{capital:-10, wellbeing:-8, globalEco:-5, pollution:8}},
  {id:47, type:'s-event',  label:'Construction',         icon:'🏗️', points:1, modifiers:{capital:2, wellbeing:1}},
  {id:48, type:'s-event',  label:'Amphitheatre',         icon:'🎪', points:2, modifiers:{wellbeing:2, capital:1, vp:1}},
  {id:49, type:'s-event',  label:'Population Explosion', icon:'🏙️', points:2, modifiers:{capital:2, globalEco:-3, wellbeing:1}},
  {id:50, type:'s-event',  label:'Plastic Eating Bacteria',icon:'🔬', points:3, modifiers:{pollution:-5, globalEco:2}},
  {id:51, type:'s-event',  label:'EV Hubs',              icon:'🔌', points:2, modifiers:{capital:2, pollution:-3}},
  {id:52, type:'s-event',  label:'Food Shortage',        icon:'🌾', points:-5, modifiers:{wellbeing:-5, capital:-3, globalEco:-2}},
  {id:53, type:'s-event',  label:'Stock Exchange',       icon:'📊', points:1, modifiers:{capital:4, wellbeing:0}},
  {id:54, type:'s-event',  label:'Biodiversity Loss',    icon:'🦋', points:-4, modifiers:{globalEco:-4, wellbeing:-1, capital:-1}},

  // LEFT EDGE CORNER
  {id:55, type:'s-corner', label:'LONELINESS',           icon:'😢', points:-2, modifiers:{wellbeing:-4, capital:-1, globalEco:-1}},
  
  // LEFT EDGE (17 cards: bottom→top)
  {id:56, type:'s-event',  label:'Ocean Plastic Cleanup',icon:'🌊', points:3, modifiers:{globalEco:4, pollution:-3, capital:1, vp:2}},
  {id:57, type:'s-event',  label:'Data Centre',          icon:'🖥️', points:1, modifiers:{capital:3, wellbeing:1, pollution:2}},
  {id:58, type:'s-event',  label:'Desertification',      icon:'🏜️', points:-4, modifiers:{globalEco:-4, land:-2}},
  {id:59, type:'s-event',  label:'Public School',        icon:'🎓', points:2, modifiers:{wellbeing:2, capital:1, vp:1}},
  {id:60, type:'s-event',  label:'Carbon Capture',       icon:'💨', points:4, modifiers:{capital:2, pollution:-4, globalEco:4, vp:2}},
  {id:61, type:'s-event',  label:'Glass Plant',          icon:'🏭', points:1, modifiers:{capital:2, pollution:2, globalEco:-1}},
  {id:62, type:'s-event',  label:'Farmers Market',       icon:'🥕', points:2, modifiers:{capital:2, wellbeing:2, globalEco:1, vp:1}},
  {id:63, type:'s-event',  label:'Smart Grid',           icon:'⚡', points:3, modifiers:{capital:3, pollution:-3, globalEco:2, vp:1}},
  {id:64, type:'s-event',  label:'Innovation',           icon:'💡', points:4, modifiers:{capital:4, wellbeing:2, vp:2}},
  {id:65, type:'s-event',  label:'Cyber Center',         icon:'💻', points:2, modifiers:{capital:3, wellbeing:1, vp:1}},
  {id:66, type:'s-event',  label:'Public Hospital',      icon:'🏥', points:2, modifiers:{wellbeing:3, capital:1, vp:1}},
  {id:67, type:'s-event',  label:'Symphony of Birds',    icon:'🎶', points:2, modifiers:{globalEco:3, wellbeing:2, vp:1}},
  {id:68, type:'s-event',  label:'Pollution Disaster',   icon:'☢️', points:-6, modifiers:{globalEco:-5, wellbeing:-4, pollution:7}},
  {id:69, type:'s-event',  label:'Subways',              icon:'🚇', points:3, modifiers:{capital:2, wellbeing:2, pollution:-2, vp:1}},
  {id:70, type:'s-event',  label:'Community Hall',       icon:'🏛️', points:2, modifiers:{wellbeing:2, capital:1}},
  {id:71, type:'s-event',  label:'Organic Farming',      icon:'🌱', points:3, modifiers:{capital:1, globalEco:3, wellbeing:2, vp:1}},
  {id:72, type:'s-event',  label:'Heavy Machinery',      icon:'🏗️', points:1, modifiers:{capital:2, pollution:4, globalEco:-1}},
];
